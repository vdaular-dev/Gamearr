...
using Gamearr.Http.Extensions.Pipelines;
using TinyIoC;

namespace Gamearr.Http
{
    public class GamearrBootstrapper : TinyIoCNancyBootstrapper
    {
        private readonly TinyIoCContainer _tinyIoCContainer;
        private static readonly Logger Logger = NzbDroneLogger.GetLogger(typeof(GamearrBootstrapper));

        public GamearrBootstrapper(TinyIoCContainer tinyIoCContainer)
        {
