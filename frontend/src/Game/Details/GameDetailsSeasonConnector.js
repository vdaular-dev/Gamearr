...
import GameDetailsSeason from './GameDetailsSeason';
...
class GameDetailsSeasonConnector extends Component {
...
GameDetailsSeasonConnector.propTypes = {
...
export default connect(createMapStateToProps, mapDispatchToProps)(GameDetailsSeasonConnector);
