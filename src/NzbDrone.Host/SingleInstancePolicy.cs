    ...
    public class SingleInstancePolicy : ISingleInstancePolicy
    {
        ...
        private List<int> GetOtherNzbDroneProcessIds()
        {
            try
            {
                ...
                var otherProcesses = _processProvider.FindProcessByName(ProcessProvider.GAMEARR_CONSOLE_PROCESS_NAME)
                                                     .Union(_processProvider.FindProcessByName(ProcessProvider.GAMEARR_PROCESS_NAME))
                                                     .Select(c => c.Id)
