...
namespace Gamearr.Api.V1.Calendar
{
    public class CalendarFeedModule : GamearrV1FeedModule
    {
            ...
            : base("calendar")
        {
            ...
            Get["/Gamearr.ics"] = options => GetCalendarFeed();
        }
        ...
        private Response GetCalendarFeed()
        {
            ...
            {
                ProductId = "-//lidarr.audio//Gamearr//EN"
            };
