...
import OrganizeGameModalContent from './OrganizeGameModalContent';
...
class OrganizeGameModalContentConnector extends Component {
...
OrganizeGameModalContentConnector.propTypes = {
  artistIds: PropTypes.arrayOf(PropTypes.number).isRequired,
  onModalClose: PropTypes.func.isRequired,
  executeCommand: PropTypes.func.isRequired
};

export default connect(createMapStateToProps, mapDispatchToProps)(OrganizeGameModalContentConnector);
