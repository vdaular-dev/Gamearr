...
import GameEditorFooterLabel from './GameEditorFooterLabel';
import styles from './GameEditorFooter.css';

const NO_CHANGE = 'noChange';

class GameEditorFooter extends Component {
      ...
      <PageContentFooter>
        ...
        <div className={styles.buttonContainer}>
          <div className={styles.buttonContainerContent}>
            <GameEditorFooterLabel
              label={`${selectedCount} Game(s) Selected`}
              isSaving={false}
            />
        ...
        <MoveGameModal
          ...
          onMoveGamePress={this.onMoveGamePress}
        />
...
export default GameEditorFooter;
