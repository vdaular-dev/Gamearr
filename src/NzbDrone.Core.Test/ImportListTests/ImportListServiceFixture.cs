...
using NzbDrone.Core.ImportLists.GamearrLists;
...
namespace NzbDrone.Core.Test.ImportListTests
{
    public class ImportListServiceFixture : DbTest<ImportListFactory, ImportListDefinition>
    {
        ...
        public void Setup()
        {
            ...
            _importLists.Add(Mocker.Resolve<GamearrLists>());
        ...
        public void should_remove_missing_import_lists_on_startup()
        {
            ...
            existingImportLists.ConfigContract = typeof (GamearrListsSettings).Name;
