...
class GameDetailsConnector extends Component {
...
GameDetailsConnector.propTypes = {
...
export default connect(createMapStateToProps, mapDispatchToProps)(GameDetailsConnector);
