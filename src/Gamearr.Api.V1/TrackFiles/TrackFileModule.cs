...
{
    public class TrackFileModule : GamearrRestModuleWithSignalR<TrackFileResource, TrackFile>,
                                 ...
                                 IHandle<TrackFileDeletedEvent>
    {
        ...
        private TrackFileResource GetTrackFile(int id)
        {
            ...
            resource.GameTags = _audioTagService.ReadTags(resource.Path);
            return resource;
        }
        ...
        private List<TrackFileResource> GetTrackFiles()
        {
            ...
            {
                throw new Gamearr.Http.REST.BadRequestException("artistId, albumId, trackFileIds or unmapped must be provided");
            }
