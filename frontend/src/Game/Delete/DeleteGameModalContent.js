...
class DeleteGameModalContent extends Component {
        ...
        <ModalBody>
          ...
          <FormGroup>
            ...
            <FormInputGroup
              ...
              helpText="Prevent artist from being added to Gamearr by Import lists"
              kind={kinds.DANGER}
...
DeleteGameModalContent.propTypes = {
...
DeleteGameModalContent.defaultProps = {
  statistics: {
    trackFileCount: 0
  }
};
