...
import GameDetailsSeasonConnector from './GameDetailsSeasonConnector';
import GameTagsConnector from './GameTagsConnector';
import GameDetailsLinks from './GameDetailsLinks';
import styles from './GameDetails.css';
import InteractiveImportModal from '../../InteractiveImport/InteractiveImportModal';
import GameInteractiveSearchModalConnector from 'Game/Search/GameInteractiveSearchModalConnector';
    ...
    return (
      <PageContent title={artistName}>
        ...
        <PageContentBodyConnector innerClassName={styles.innerContentBody}>
            ...
            <div className={styles.headerContent}>
              ...
              <div className={styles.info}>
                      ...
                      !!alternateTitles.length &&
                        <div className={styles.alternateTitlesIconContainer}>
                          <Popover
                            ...
                            body={<GameAlternateTitles alternateTitles={alternateTitles} />}
                ...
                <div className={styles.detailsLabels}>
                  ...
                  >
                    <Icon
                      name={continuing ? icons.GAME_CONTINUING : icons.ARTIST_ENDED}
                      size={17}
                    />
...

                  {
                    !!tags.length &&
                      <Tooltip
                        ...
                        tooltip={<GameTagsConnector artistId={id} />}
                        kind={kinds.INVERSE}
                        position={tooltipPositions.BOTTOM}
                      />
          ...
          <GameInteractiveSearchModalConnector
