...
import GameIndexHeaderConnector from './GameIndexHeaderConnector';
import GameIndexRow from './GameIndexRow';
import styles from './GameIndexTable.css';

class GameIndexTable extends Component {
