...
using Gamearr.Http.ErrorManagement;
...
namespace NzbDrone.Api.Extensions.Pipelines
{
    public class RequestLoggingPipeline : IRegisterNancyPipeline
    {
        ...
        private readonly GamearrErrorPipeline _errorPipeline;

        public RequestLoggingPipeline(GamearrErrorPipeline errorPipeline)
        {
