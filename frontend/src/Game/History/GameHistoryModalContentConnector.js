...
import GameHistoryModalContent from './GameHistoryModalContent';
...
class GameHistoryModalContentConnector extends Component {
...
GameHistoryModalContentConnector.propTypes = {
...
export default connect(createMapStateToProps, mapDispatchToProps)(GameHistoryModalContentConnector);
