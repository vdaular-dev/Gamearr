...
namespace NzbDrone.Core.HealthCheck.Checks
{
    ...
    public class IndexerSearchCheck : HealthCheckBase
    {
        ...
        public override HealthCheck Check()
        {
            ...
            {
                return new HealthCheck(GetType(), HealthCheckResult.Warning, "No indexers available with Automatic Search enabled, Gamearr will not provide any automatic search results");
            }
            ...
            {
                return new HealthCheck(GetType(), HealthCheckResult.Warning, "No indexers available with Interactive Search enabled, Gamearr will not provide any interactive search results");
            }
