...
class AddNewGame extends Component {
  ...
  render() {
    ...
    return (
      <PageContent title="Add New Game">
        <PageContentBodyConnector>
          <div className={styles.searchContainer}>
            ...
            <TextInput
              ...
              name="artistLookup"
              value={term}
              placeholder="eg. Final Fantasy XV, gamearr:854a1807-025b-42a8-ba8c-2a39717f1d25"
              autoFocus={true}
...

          {
            !isFetching && !error && !items.length && !!term &&
              <div className={styles.message}>
                ...
                <div>You can also search using Game Database ID of an game. eg. gamearr:cc197bad-dc9c-440d-a5b5-d52ba2e14234</div>
                <div>
                  <Link to="https://github.com/Gamearr/Gamearr/wiki/">
...

          {
            !term &&
              <div className={styles.message}>
                <div className={styles.helpText}>It's easy to add a new game, just start typing the name the game you want to add.</div>
                <div>You can also search using Game Database ID of an game. eg. gamearr:cc197bad-dc9c-440d-a5b5-d52ba2e14234</div>
              </div>
          }
