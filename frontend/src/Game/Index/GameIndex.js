...
import GameIndexTableConnector from './Table/GameIndexTableConnector';
import GameIndexTableOptionsConnector from './Table/GameIndexTableOptionsConnector';
import GameIndexPosterOptionsModal from './Posters/Options/GameIndexPosterOptionsModal';
import GameIndexPostersConnector from './Posters/GameIndexPostersConnector';
import GameIndexBannerOptionsModal from './Banners/Options/GameIndexBannerOptionsModal';
import GameIndexBannersConnector from './Banners/GameIndexBannersConnector';
import GameIndexOverviewOptionsModal from './Overview/Options/GameIndexOverviewOptionsModal';
import GameIndexOverviewsConnector from './Overview/GameIndexOverviewsConnector';
import GameIndexFooterConnector from './GameIndexFooterConnector';
...
function getViewComponent(view) {
  if (view === 'posters') {
    return GameIndexPostersConnector;
  }

  if (view === 'banners') {
    return GameIndexBannersConnector;
  }

  if (view === 'overview') {
    return GameIndexOverviewsConnector;
  }

  return GameIndexTableConnector;
}
          ...
          >
            {
              view === 'table' ?
                <TableOptionsModalWrapper
                  {...otherProps}
                  columns={columns}
                  optionsComponent={GameIndexTableConnector}
                >
                  <PageToolbarButton
                    label="Options"
