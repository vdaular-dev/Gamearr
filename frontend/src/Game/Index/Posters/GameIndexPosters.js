...
import GameIndexItemConnector from 'Game/Index/GameIndexItemConnector';
import GameIndexPoster from './GameIndexPoster';
import styles from './GameIndexPosters.css';
...
class GameIndexPosters extends Component {
  ...
  cellRenderer = ({ key, rowIndex, columnIndex, style }) => {
    ...
    return (
      <GameIndexItemConnector
        key={key}
        component={GameIndexPoster}
        sortKey={sortKey}
...
export default GameIndexPosters;
