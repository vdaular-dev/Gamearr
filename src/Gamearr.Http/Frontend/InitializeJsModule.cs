...
namespace Gamearr.Http.Frontend
{
    public class InitializeJsModule : NancyModule
    {
        ...
        {
            // TODO: Move away from window.Gamearr and prefetch the information returned here when starting the UI
        ...
        private string GetContent()
        {
            ...
            builder.AppendLine("window.Gamearr = {");
