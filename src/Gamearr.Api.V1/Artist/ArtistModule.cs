...
{
    public class ArtistModule : GamearrRestModuleWithSignalR<ArtistResource, NzbDrone.Core.Music.Artist>, 
...

    {
        ...
        private int AddGame(ArtistResource artistResource)
        {
            var artist = _addArtistService.AddGame(artistResource.ToModel());
