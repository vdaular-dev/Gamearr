...
import GameDetailsConnector from './GameDetailsConnector';
...
class GameDetailsPageConnector extends Component {
  ...
  componentDidUpdate(prevProps) {
    if (!this.props.foreignArtistId) {
      this.props.push(`${window.Gamearr.urlBase}/`);
      return;
    }
  }
...
GameDetailsPageConnector.propTypes = {
...
export default connect(createMapStateToProps, mapDispatchToProps)(GameDetailsPageConnector);
